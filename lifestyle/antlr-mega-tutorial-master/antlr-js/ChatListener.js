...
// Enter a parse tree produced by ChatParser#verb.
ChatListener.prototype.enterVerb = function(ctx) {
};

// Exit a parse tree produced by ChatParser#verb.
ChatListener.prototype.exitVerb = function(ctx) {
};


// Enter a parse tree produced by ChatParser#object.
ChatListener.prototype.enterObject = function(ctx) {
};

// Exit a parse tree produced by ChatParser#object.
ChatListener.prototype.exitObject = function(ctx) {
};


// Enter a parse tree produced by ChatParser#reason.
ChatListener.prototype.enterReason = function(ctx) {
};

// Exit a parse tree produced by ChatParser#reason.
ChatListener.prototype.exitReason = function(ctx) {
};


// Enter a parse tree produced by ChatParser#method.
ChatListener.prototype.enterMethod = function(ctx) {
};

// Exit a parse tree produced by ChatParser#method.
ChatListener.prototype.exitMethod = function(ctx) {
};


// Enter a parse tree produced by ChatParser#time.
ChatListener.prototype.enterTime = function(ctx) {
};

// Exit a parse tree produced by ChatParser#time.
ChatListener.prototype.exitTime = function(ctx) {
};
